...
class SoftGroupUnet(nn.Module):
    ...
    def forward_sim(self, batch_idxs, voxel_coords, p2v_map, v2p_map, coords_float, feats,
    ...
    def forward_train(self, batch_idxs, voxel_coords, p2v_map, v2p_map, coords_float, feats,
        ...
        output_feats = self.to_high_mlp(output_feats)
        #TODO: MASK labels
        # print(torch.unique(semantic_labels))
        # for label in self.mask_labels:
            # print(semantic_labels[0])
            # print(semantic_labels[0] - label)
            # print(semantic_labels[semantic_labels!=-100].min(), semantic_labels[semantic_labels!=-100].max())
            # print(torch.abs(semantic_labels - label).min())
            # pass
        ...
        #TODO: style loss
        #style_loss = self.style_loss(clip_fcs, output_feats)
    ...
    def feature_loss(self, clip_features, model_features, valid_index):
        ...
        #     model_features = model_features[idx, :]
        #print(clip_features.shape)
        #print("*" * 100)
